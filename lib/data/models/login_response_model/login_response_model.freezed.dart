...
class _$UserDataModelImpl implements _UserDataModel {
  ...
  @override
  String toString() {
    return 'UserDataModel(id: $id, name: $name, phone: $phone, role: $role, verificationStatus: $verificationStatus, token: $token)';
  }
...
abstract class $LoginResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? message, UserDataModel? user, String? token});
...
class _$LoginResponseModelImpl implements _LoginResponseModel {
  const _$LoginResponseModelImpl({this.message, this.user, this.token});
